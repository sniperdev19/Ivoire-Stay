/* ============================================================
   Ivoire Stay — Page connexion SaaS
   Dépend de pwa.js (chargé avant) qui expose window.IvoireStayPWA.
   ============================================================ */
    ...
    async submit() {
      ...
      try {
        ...
        if (data.success) {
          ...
          window.location.href = redirect ? decodeURIComponent(redirect) : baseUrl + '/saas';
        } else {
