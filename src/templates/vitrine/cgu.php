...
<div style="max-width:820px;margin:0 auto;padding:64px 24px 96px;font-family:'Inter',sans-serif;color:#1B4332;">
  ...
  <div style="margin-bottom:8px;">
    <span style="display:inline-block;font-size:11px;font-weight:600;letter-spacing:0.14em;text-transform:uppercase;color:#C9A84C;">Informations légales</span>
  </div>
  <h1 style="font-family:'Cormorant Garamond',serif;font-size:40px;font-weight:600;margin:0 0 8px;color:#1B4332;">Conditions générales d'utilisation</h1>
  ...
  <div style="font-size:15px;line-height:1.85;color:rgba(27,67,50,0.85);">
    ...
    <h2 style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:32px 0 12px;color:#1B4332;">1. Objet</h2>
    ...
    <h2 style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:32px 0 12px;color:#1B4332;">2. Définitions</h2>
    <ul style="padding-left:20px;">
      <li><strong>Voyageur</strong> : toute personne effectuant une recherche ou une réservation via la Vitrine.</li>
      <li><strong>Hôtelier / Établissement</strong> : professionnel disposant d'un compte sur l'Espace hôtelier pour gérer son ou ses établissements.</li>
      <li><strong>Réservation</strong> : engagement pris par un Voyageur auprès d'un Établissement via la Plateforme.</li>
    </ul>

    <h2 style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:32px 0 12px;color:#1B4332;">3. Rôle d'intermédiaire</h2>
    ...
    <h2 style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:32px 0 12px;color:#1B4332;">4. Compte et inscription (Espace hôtelier)</h2>
    ...
    <h2 style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:32px 0 12px;color:#1B4332;">5. Réservations et paiement</h2>
    ...
    <h2 style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:32px 0 12px;color:#1B4332;">6. Abonnements (Espace hôtelier)</h2>
    <p>L'accès à certaines fonctionnalités de l'Espace hôtelier (facturation, dépenses, rapports, multi-établissements)
      est conditionné à un abonnement payant. Les tarifs et fonctionnalités de chaque formule sont indiqués sur la
      page Tarifs et peuvent évoluer. Un abonnement non renouvelé à son échéance repasse automatiquement sur la
      formule gratuite, avec restriction des fonctionnalités concernées.</p>

    <h2 style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:32px 0 12px;color:#1B4332;">7. Obligations de l'utilisateur</h2>
    ...
    <h2 style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:32px 0 12px;color:#1B4332;">8. Propriété intellectuelle</h2>
    ...
    <h2 style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:32px 0 12px;color:#1B4332;">9. Modification des CGU</h2>
    ...
    <h2 style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:32px 0 12px;color:#1B4332;">10. Droit applicable</h2>
    ...
    <h2 style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:32px 0 12px;color:#1B4332;">11. Contact</h2>
    <p>Pour toute question relative aux présentes CGU : <a href="<?= $base_url ?>/contact" style="color:#C9A84C;">nous contacter</a>.</p>
