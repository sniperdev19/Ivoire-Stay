  ...
  <div class="saas-layout" x-data="saasLayout('<?= $base_url ?? '' ?>')" x-init="init()">
    <aside class="saas-sidebar" :class="sidebarOpen ? 'mobile-open' : ''">
      ...
      <nav style="flex:1;overflow-y:auto;padding-bottom:16px;">
        ...
        <div class="saas-nav-section">
          ...
          <?php /* Masqué tant que le verrou v1 (ONLINE_PAYMENTS_ENABLED) est fermé — voir memoire.md,
                   pas de retrait possible sans paiement en ligne actif. Réapparaît automatiquement dès
                   que le flag passe à true, pas besoin d'y repenser manuellement. */ ?>
    ...
    <?php
      ...
      $moreTabs = [
        ...
        // Masqué tant que le verrou v1 (ONLINE_PAYMENTS_ENABLED) est fermé — réapparaît
        // automatiquement dès que le flag passe à true (voir équivalent desktop plus haut).
        ...(ONLINE_PAYMENTS_ENABLED ? [
          ['key'=>'payouts','label'=>'Retraits','href'=>'/saas/payouts','icon'=>'M17 9V7a4 4 0 00-8 0v2M5 9h14l1 11H4L5 9z','guard'=>'canSeeFinance'],
        ] : []),
