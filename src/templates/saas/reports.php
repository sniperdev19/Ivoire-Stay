  ...
  <div style="display:grid;grid-template-columns:60% 40%;gap:12px;margin-bottom:12px;">
    ...
    <div class="saas-card">
      ...
      <div style="display:flex;flex-direction:column;gap:12px;">
        ...
        <div style="border-top:1px solid rgba(0,0,0,0.06);padding-top:12px;background:var(--);border-radius:6px;">
...
<div class="reports">
    <h2>Rapports</h2>
    <div id="reports">Rapports financiers et statistiques...</div>
</div>
